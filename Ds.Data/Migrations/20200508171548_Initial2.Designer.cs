...
namespace Ds.Data.Migrations
{
    ...
    [Migration("20200508171548_Initial2")]
            ...
            modelBuilder.Entity("Ds.Business.Models.Nota", b =>
                {
                    b.HasOne("Ds.Business.Models.Aluno", "Aluno")
                        .WithOne("Nota")
                        .HasForeignKey("Ds.Business.Models.Nota", "AlunoId")
                        .IsRequired();

                    b.HasOne("Ds.Business.Models.Disciplina", "Disciplina")
                        .WithOne("Nota")
                        .HasForeignKey("Ds.Business.Models.Nota", "DisciplinaId")
                        .IsRequired();

                    b.HasOne("Ds.Business.Models.Periodo", "Periodo")
                        .WithOne("Nota")
                        .HasForeignKey("Ds.Business.Models.Nota", "PeriodoId")
                        .IsRequired();
                });
